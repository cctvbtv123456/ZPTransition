//
//  ZPAnimationTypeBottomViewAlert.m
//  ZPTransition
//
...
@implementation ZPAnimationTypeBottomViewAlertPress
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    toVC.view.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height, toVC.view.frame.size.width, ZPTransitionPressHeight);
    ...
    [UIView animateWithDuration:[self transitionDuration:transitionContext] delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        ...
        toVC.view.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height - ZPTransitionPressHeight, toVC.view.frame.size.width, ZPTransitionPressHeight);
...
@implementation ZPAnimationTypeBottomViewAlertDiss
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    [UIView animateWithDuration:ZPTransitionTime delay:0 options:UIViewAnimationOptionCurveEaseOut animations:^{
        toVC.view.alpha = 1;
